...
public class HearthStoneMod implements ECSMod {
    public enum HearthStoneResource implements ECSResource {
        ...
        TURN, NUM_MINIONS_KILLED_THIS_TURN, TURN_START, RESOURCES, NUM_OPTIONS, TURN_TIMER_SLUSH, NUM_CARDS_PLAYED_THIS_TURN,
        COMBO_ACTIVE, TEMP_RESOURCES, NUM_MINIONS_PLAYED_THIS_TURN, NUM_OPTIONS_PLAYED_THIS_TURN, NUM_MINIONS_PLAYER_KILLED_THIS_TURN,
        GOLD_REWARD_STATE, RESOURCES_USED, PREDAMAGE, PROPOSED_ATTACKER, PROPOSED_DEFENDER, ATTACKING, DEFENDING,
        TO_BE_DESTROYED, SILENCED,
        _10{
            @Override
    ...
    public enum HearthStoneAttribute implements ECSAttribute {
        ZONE, FACTION, CARDTYPE, RARITY, CLASS, PLAYSTATE, NEXT_STEP, STATE, STEP, MULLIGAN_STATE;
